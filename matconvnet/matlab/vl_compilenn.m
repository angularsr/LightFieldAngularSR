...
lib_src{end+1} = fullfile(root,'matlab','src','bits',['nnconv6D.' ext]) ;
...
mex_src{end+1} = fullfile(root,'matlab','src',['vl_nnconv6D.' ext]) ;
...
lib_src{end+1} = fullfile(root,'matlab','src','bits','impl','im2row_cpu6D.cpp') ;
...
if opts.enableGpu
  ...
  lib_src{end+1} = fullfile(root,'matlab','src','bits','impl','im2row_gpu6D.cu') ;
...
if opts.enableCudnn
  ...
  lib_src{end+1} = fullfile(root,'matlab','src','bits','impl','nnconv6D_cudnn.cu') ;
